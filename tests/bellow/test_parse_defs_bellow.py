...
class TestParser(unittest.TestCase):
    ...
    def setUp(self):
        self.d_parser = DictParser(TestParser.root, "bellow")
...
(OR)11 KEYS: class="inflected_forms"                        -- word forms
    ...
    def test_have_2_def_groups(self):
    ...
    def test_get_all_grammar_groups_for_first(self):
        ...
        self.assertEqual(3, len(ggroups))
    ...
    def test_get_all_gram_value_of_def_group(self):
        ...
        self.assertEqual(["intransitive verb", "transitive verb", "noun"], gram_values)
    ...
    def test_get_gram_value_of_gram_group(self):
        ...
        self.assertEqual("intransitive verb", gram_value)
    ...
    def test_get_word_forms_for_def_group(self):
        ...
        self.assertEqual(['bellow', 'Bellow'], word_forms)
    ...
    def test_get_def_from_senselist_item(self):
        ...
        self.assertEqual(word_def, "to roar with a powerful, reverberating sound, as a bull does")
