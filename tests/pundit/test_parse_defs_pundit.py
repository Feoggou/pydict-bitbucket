...
class TestParser(unittest.TestCase):
    ...
    def setUp(self):
        self.d_parser = DictParser(TestParser.root, TestParser.word_name)
...
(OR)11 KEYS: class="inflected_forms"                        -- word forms
    ...
    def test_get_all_grammar_groups_for_first(self):
        ...
        self.assertEqual(id, ("id", "{}_1.1".format(TestParser.word_name)))
    ...
    def test_get_all_gram_value_of_def_group(self):
        ...
        self.assertEqual(["noun"], gram_values)
    ...
    def test_get_word_forms_for_def_group(self):
        ...
        self.assertEqual(['pundit'], word_forms)

    def test_get_all_senselist_item_level1_from_gram_group_returns_2(self):
        def_group = self.d_parser.get_all_def_groups()[0]
        ggroup = self.d_parser.get_all_grammar_groups(def_group)[0]
        ...
        self.assertEqual(len(sslist_items), 2)
    ...
    def test_get_def_from_senselist_item(self):
        ...
        self.assertEqual(word_def, "pandit (def. 1)")
    ...
    def test_get_category_from_sslist_item(self):
        ...
        self.assertEqual("var. of", word_categ)
