...
class TestParser(unittest.TestCase):
    ...
    def test_print_siblings(self):
        # print("tag: ", self.root.tag)
        elem = self.root.xpath('/html/body/main/div[@class="dictionary"]/div[@class="res_cell_center"]/div/div[@id="do_1"]/div[@class="homograph-entry"]/div/div/'
                               'div[@class="Collins_Eng_Dict dictionary"]/div')[0]

        elem = elem.xpath("./div/div")[0]
