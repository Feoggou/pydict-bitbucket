...
class TestParser(unittest.TestCase):
    ...
    def setUp(self):
        self.d_parser = DictParser(TestParser.root, "pell-mell")
...
(OR)11 KEYS: class="inflected_forms"                        -- word forms
    ...
    def test_get_all_examples(self):
        ...
        self.assertEqual(examples[0],
            'Somehow in his pell-mell race through the woods he had left her behind.')

        self.assertEqual(len(examples), 1)

    def test_get_all_nearby_words(self):
        nearby_words = self.d_parser.get_all_nearby_words()
        self.assertEqual(nearby_words[0], "pelecypod")
    ...
    def test_get_all_grammar_groups_for_first(self):
        ...
        self.assertEqual(id, ("id", "pellmell_1.1"))
    ...
    def test_get_all_gram_value_of_def_group(self):
        ...
        self.assertEqual(["adverb", "adjective", "noun"], gram_values)
    ...
    def test_get_gram_value_of_gram_group(self):
        ...
        self.assertEqual("adverb adjective", gram_value)
    ...
    def test_get_word_forms_for_def_group(self):
        ...
        self.assertEqual(['pell-mell'], word_forms)
    ...
    def test_get_def_from_senselist_item(self):
        ...
        self.assertEqual(word_def, "in wild, disorderly haste; headlong")
